...
caenTextFile_to_Root.o: caenTextFile_to_Root.cpp
	$(CC) -Wall -c caenTextFile_to_Root.cpp -o caenTextFile_to_Root.o $(CPPFLAGS)

fitFunctions.o: fitFunctions.cpp
	$(CC) -Wall -c fitFunctions.cpp -o fitFunctions.o $(CPPFLAGS)

caenTextFile_to_Root: $(OBJFILES)
	$(CC) -o caenTextFile_to_Root $(OBJFILES) $(CPPFLAGS)
